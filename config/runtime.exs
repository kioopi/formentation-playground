...
#
#     PHX_SERVER=true bin/frmn_play start
#
  ...
  config :frmn_play, FrmnPlayWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/frmn_play_web/router\.ex$"E,
        ~r"lib/frmn_play_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :frmn_play, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :frmn_play, FrmnPlay.Mailer,
